...
define('DEFAULT_DatbaseServerType', 'mongodb');
define('DEFAULT_DatabaseServerUrl', 'localhost');
define('DEFAULT_DatabaseServerPort', 27017);
define('DEFAULT_DatabaseDefaultName', 'kraa');
define('DEFAULT_DatabaseDefaultCollectionName', 'vericloudsApiResponses');

define('DEFAULT_VericloudsApiUrl', 'https://api.vericlouds.com/index.php');
define('DEFAULT_VericloudsApiKey', 'CustomerTRIAL_KRAA');
define('DEFAULT_VericloudsApiSecret', 'adba730d8f485dbc210fb73f909cb394c8d7957488db9c36ebc991fcc567073f');
//define('DEFAULT_', '');
